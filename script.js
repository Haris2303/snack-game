...
function draw() {
  ...
  createRect(0,0, canvas.width, canvas.height, 'gray')
  for( var i = 0; i < snake.tail.length; i++) {
...
function createRect(x,y,width,heigth, color) {
...
left.addEventListener('click', () => {
  if (snake.rotateX != 1 && snake.rotateY != 0) {
    snake.rotateX = -1
    snake.rotateY = 0
  }
})
...
up.addEventListener('click', () => {
  if (snake.rotateX != 0 && snake.rotateY != 1) {
    snake.rotateX = 0
    snake.rotateY = -1
  }
})
